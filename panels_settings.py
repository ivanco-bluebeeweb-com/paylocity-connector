"""Settings panel for Paylocity Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__paylocity_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=paylocity_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_paylocity"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Paylocity Settings & Accounts", level=2),
